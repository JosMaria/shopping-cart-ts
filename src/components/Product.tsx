...
import { ProductType, ReducerAction, ReducerActionType } from '../contexts'
...
function areProductsEqual({ product: prevProduct, inCart: prevInCart }: PropsType, { product: nextProduct, inCart: nextInCart }: PropsType) {
  return (
    Object.keys(prevProduct).every(key => prevProduct[key as keyof ProductType] === nextProduct[key as keyof ProductType])
